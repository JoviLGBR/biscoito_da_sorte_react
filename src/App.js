...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      textoFrase: "",
      caminhoImagem: require("./assets/biscoito.png"),
      nomeBotao: "Abrir Biscoito",
      opcaoBotao: this.quebraBiscoito.bind(this),
    };
    ...
    this.abrirNovamente = this.abrirNovamente.bind(this);
  }
  ...
  quebraBiscoito() {
    ...
    state.caminhoImagem = require("./assets/biscoito_aberto.png");
    state.nomeBotao = "Realizar novamente";
    state.opcaoBotao = this.abrirNovamente;

    state.quebraBiscoito = this.setState(state);
  }
  ...
  abrirNovamente() {
    ...
    state.textoFrase = "";
    state.caminhoImagem = require("./assets/biscoito.png");
    state.nomeBotao = "Abrir Biscoito";
    state.opcaoBotao = this.quebraBiscoito;

    state.abrirNovamente = this.setState(state);
  }

  render() {
    return (
      <div className="container">
        <img src={this.state.caminhoImagem} className="img" />
        <Botao nome={this.state.nomeBotao} acaoBtn={this.state.opcaoBotao} />
